...
local function createItemCard(itemId, itemData, category, parent)
    ...
    if not (category == "pets" and petMode == "Speed") then
        ...
        -- Update config when input loses focus (simple, no debouncing)
...
refreshContent = function()
    ...
    if currentTab == "Pets" then
        ...
        -- Speed input functionality (simple, no debouncing)
        minInput.FocusLost:Connect(function()
            -- Handle empty input for min speed
        ...
        maxInput.FocusLost:Connect(function()
            -- Handle empty input for max speed
            local inputText = maxInput.Text
            if inputText == "" then
                maxInput.Text = "999999999"
                inputText = "999999999"
            end
