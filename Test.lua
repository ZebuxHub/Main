...
Tabs.AutoTab:Button({
    ...
    Callback = function()
        ...
        message = message .. string.format("🛒 Buying In Progress: %s", tostring(buyingInProgress))
...
local function setupAntiAFK()
    ...
    WindUI:Notify({ Title = "🛡️ Anti-AFK", Content = "Anti-AFK activated! You won't be kicked for inactivity.", Duration = 3 })
end
