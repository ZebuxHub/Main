...
local function createFruitStoreSystem(Tabs, WindUI, LocalPlayer, ReplicatedStorage, Players)
    ...
    -- Hardcoded fruit list for better config saving
    ...
    Tabs.FruitTab:Button({
        ...
        Callback = function()
            if fruitDropdown and fruitDropdown.Refresh then
                fruitDropdown:Refresh(hardcodedFruitList)
            end
            updateFruitStatus()
    ...
    Tabs.FruitTab:Button({
        ...
        Callback = function()
            selectedFruitSet = {}
            for _, n in ipairs(hardcodedFruitList) do selectedFruitSet[n] = true end
            fruitStatus.selected = table.concat(hardcodedFruitList, ", ")
            updateFruitStatus()
