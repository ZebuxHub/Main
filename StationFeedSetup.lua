...
local function createFruitSelectionPopup(stationId, stationDisplayName, parentFrame, refreshCallback)
    ...
    subtitle.Text = "เลือกผลไม้ที่ต้องการให้ Station นี้กิน"
    ...
    selectAll.Size = UDim2.new(1, -16, 0, 36)
    ...
    clearAll.Size = UDim2.new(1, -16, 0, 36)
...
local function createMainUI()
    ...
    titleLabel.Text = "🍎 Auto Feed - Station Setup"
    ...
    local function refreshStations()
        ...
        if #pets == 0 then
            ...
            noStations.Text = "ไม่พบ Big Pets\nกรุณาวาง Big Pet ก่อน"
